...
enum class HttpStatusCode(val code: Int, val codeName: String, val description: String) {
    ...
    REQUESTED_URI_TOO_LONG(414, "Request URI Too Long", "The request was unsuccessful because the requested URI is longer than the server is willing to process (that's what she said)."),
